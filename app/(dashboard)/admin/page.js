...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const userStatCtx = document.getElementById("userstat").getContext("2d");
    ...
    <div className="row">
      ...
      <div className="col-md-4">
        <div className="card bg-light border-0 shadow-sm p-4 rounded-5 border-bottom border-5 border-danger">
          ...
          const value =
            index === 0 ? totals.totalEarnings : index === 1 ? totals.pending : totals.inReview;
      ...
      <div className="col-md-12 mb-4">
        ...
        <div>
          {cities.map((city, index) => (
            ...
            >
              <div
                className="bg-green-linear py-1 rounded-3"
