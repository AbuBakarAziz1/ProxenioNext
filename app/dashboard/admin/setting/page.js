    ...
    <>
      <main className="container">
        <div className="d-flex justify-content-between align-items-center mb-2">
          <h5>Your Charges List</h5>
          <button className="btn btn-outline-danger px-5" data-bs-toggle="modal" data-bs-target="#addModal">
            Add New
          </button>
        </div>
            ...
            <div className="modal-content">
              ...
              <div className="modal-body">
                <form>
                  ...
                  <div className="d-grid pt-3">
                    <button type="button" className="btn btn-primary" onClick={() => handleUpdate(editing)}>
                      Save Changes
                    </button>
                  </div>
                </form>
