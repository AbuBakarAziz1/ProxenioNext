    ...
    <>
      ...
      <div className={`sidebar border-end ${isSidebarOpen ? "open" : "closed"}`} id="sidebar">
        ...
        <Image src="/assets/img/LogoProxenio.png" width={45} height={45} alt="Logo" />
          {isSidebarOpen && (
            <Link className="navbar-brand ps-1 fs-5 fw-medium color-maroon" href="/dashboard/admin" >
              Proxenio </Link>
        ...
        <div className="sidebar-menu d-flex flex-column justify-content-center">
          <SidebarLink href="/dashboard/admin" icon="bi-house-door" label="Dashboard" pathname={pathname} />
          <SidebarLink href="/dashboard/admin/users" icon="bi-people" label="Users" pathname={pathname} />
          <SidebarLink href="/dashboard/admin/matches" icon="bi-heart" label="Matches" pathname={pathname} />
          <SidebarLink href="/dashboard/admin/payments" icon="bi-currency-dollar" label="Payments" pathname={pathname} />
          <SidebarLink href="/dashboard/admin/content" icon="bi-file-text" label="Content" pathname={pathname} />
          <SidebarLink href="/dashboard/admin/profile" icon="bi-person" label="Profile" pathname={pathname} />
          <SidebarLink href="/dashboard/admin/setting" icon="bi-gear" label="Settings" pathname={pathname} />
          <SidebarLink href="/dashboard/admin/roles" icon="bi-gear" label="Roles" pathname={pathname} />
            ...
            <div className="row align-items-center mb-5">
                ...
                <div className="col-md-6 d-none d-md-flex justify-content-end align-items-center">
                    ...
                    <div className="text-start me-5">
                        <h5 className="mb-0 text-muted">{user.username}</h5>
